...
<div class="flex  items-center justify-center gap-5 pb-5">
  ...
  foreach ($data['Categories'] as $categorie) {
    ...
    // die;
  ?>
    <a href="<?= URLROOT ?>/UserController/wikifilter?id=<?= $categorie->getIdCat() ?>" class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 focus:outline-none focus:border-yellow-700"><?= $categorie->getNameCat() ?></a>
  <?php } ?>
</div>
  ...
  <div class="flex gap-4 flex-wrap">
    ...
    <div class="max-w-sm min-w-sm  bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
      ...
      <div class="p-6">
        ...
        <p class="mt-2 text-gray-700 dark:text-gray-400"><?= $wiki->getDescriptionWiki() ?></p>
